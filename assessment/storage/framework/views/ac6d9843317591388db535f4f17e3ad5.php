                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            ...
                            <span class="fw-semibold"><?php echo e($department->name); ?></span>
                        </div>
                    </td>
                    <td>
                        <span class="badge bg-info">
                            <?php echo e($department->employees_count ?? $department->employees->count()); ?> 
                            <?php echo e(Str::plural('employee', $department->employees_count ?? $department->employees->count())); ?>
                ...
                <tr>
                    <td colspan="4" class="text-center py-5">
                        <div class="text-muted">
                            ...
                            <a href="<?php echo e(route('departments.create')); ?>" class="btn btn-primary btn-sm mt-3">
...
<?php /**PATH /var/www/html/resources/views/departments/partials/table.blade.php ENDPATH**/ ?>