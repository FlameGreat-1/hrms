document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateEmail(email) {
        ...
        ValidationHelpers.checkEmailAvailability(email)
            .then(response => {
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            const emptySkills = Array.from(skillsContainer.querySelectorAll('select[name="skills[]"]'))
                .filter(select => !select.value);
            
            emptySkills.forEach(select => {
